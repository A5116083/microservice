...
public class CatelogServiceAPI extends RestApiBaseVerticle {

    public static final String SERVICE_NAME = "catelog-rest-api";

    private static final String API_ADD = "/add";
    private static final String API_RETRIEVE_BY_PAGE = "/catelogs";
    private static final String API_RETRIEVE_ALL = "/catelogs";
    private static final String API_RETRIEVE_PRICE = "/:productId/price";
    private static final String API_RETRIEVE = "/:catelogId";
    private static final String API_UPDATE = "/:catelogId";
    private static final String API_DELETE = "/:catelogId";
